...
def slowprint(s):
    for c in s + '\n' :
        ...
        sys.stdout.flush()
        time.sleep(10. / 100)
slowprint("[+] Başlatılıyor : ")
time.sleep(5)
os.system('clear')
print('''
\033[96m
>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
>----WEB ADMİN PANEL FİNDER-----<
>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
> # CREATED BY MARS             <
>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
> # BU ARAÇ;                    <
> # deneme amaçlı yapılmıştır   <
> #                             <
> #                             <
> #                             <
>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
''')
print ("\033[95m PROTOKOL HTTPS://veya HTTP://ör.: https://www.örnek.com YAZMALISINIZ.")
print ("\033[95m SİTENİN SONUNA ÖRNEK : www.örnek.com/ YAZMALISINIZ.")
url =  input("\033[97m Web Site Adresini Giriniz : ")
...
for hani in passe :
    ...
    try:
       ...
       print ("                                                             ")
       print ("\033[92m :::: BAŞARILI :::: ADMIN PANEL BULUNDU :::"+curl)
       print ("_____________________________________________________________")
    except urllib.error.URLError as msg :
        print ("\033[0;91m **** ADMIN PANEL BULUNAMADI ::::"+curl)

print ("_________________________________________________________________________")
print ("                                                                         ")
print ("\033[93m YARDIM EDEBİLDİYSEM TEŞŞEKÜRLER , HİÇ BİRŞEY İMKANSIZ DEĞİLDİR  -Mars0J")
print ("_________________________________________________________________________")
